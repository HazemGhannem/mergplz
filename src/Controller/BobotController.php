...
class BobotController extends Controller{
    ...
    function messageAction(Request $request)
    {
        ...
        $botman->hears('(resto|restaurant|i am a restaurant owner)', function (BotMan $bot) {
            $bot->reply('glade you ask you can contact us on this email "ghannemhazem@gmail.com" to verify your account as restaurant owner ');
        });
